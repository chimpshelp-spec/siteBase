...
const ELEMENTS = [
  { name: "Fire", color: "#FF4500", glow: "#FFD700", lore: "Born of the world's first eruption. Fire bends heat and fury — a force that consumes to create." },
  { name: "Water", color: "#1E90FF", glow: "#00BFFF", lore: "The patient architect. Water carves canyons, heals wounds, and drowns armies. It flows around resistance." },
  { name: "Lightning", color: "#FFD700", glow: "#FFFACD", lore: "Pure velocity made visible. Lightning strikes before thought arrives. Those who channel it move like the storm." },
  { name: "Nature", color: "#228B22", glow: "#7CFC00", lore: "The slow empire. Nature grows through stone and reclaims ruins. Its wielders command roots and rot." },
  { name: "Ice", color: "#87CEEB", glow: "#E0FFFF", lore: "Stillness weaponized. Ice freezes motion, locks wounds shut, and shatters what it cannot hold." },
  { name: "Wind", color: "#F8F8FF", glow: "#DCDCDC", lore: "The unseen sovereign. Wind lifts, cuts, and carries. It answers no wall and trusts no anchor." },
  { name: "Earth", color: "#A0522D", glow: "#FF8C00", lore: "The unmovable oath. Earth is weight, foundation, and memory. Its keepers raise mountains and staunch the ground." },
  { name: "Shadow", color: "#4B0082", glow: "#9400D3", lore: "The space between things. Shadow hides, mirrors, and devours light. Those who bind it find secrets in absence." },
];
